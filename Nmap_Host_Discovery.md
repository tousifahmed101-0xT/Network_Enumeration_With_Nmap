...
This method depends on the firewall configuration of target hosts. If a firewall blocks ICMP requests, the host will appear offline even if it is active. Additional techniques for such situations are covered in firewall and IDS evasion topics.
